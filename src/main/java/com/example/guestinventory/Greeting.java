 ...
 * {@link ObjectifyHelper} Our primary key @Id is set automatically by the
...
public class Greeting {
	...
	public Greeting(String book, String content) {
		this();
		if (book != null) {
			theBook = Key.create(Guestinventory.class, book); // Creating the
																// Ancestor key
		} else {
			theBook = Key.create(Guestinventory.class, "default");
		}
